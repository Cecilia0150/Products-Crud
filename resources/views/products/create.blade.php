...
<div class="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
  <div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('products.index') }}"
      class="bg-stone-400 hover:bg-stone-600 text-white font-bold py-2 px-4 rounded">
      Volver
    </a>
  </div>
  ...
  <form action="{{ route('products.store') }}" method="POST">
    ...
    <div class="flex items-center justify-between">
      <button type="submit"
        class="bg-lime-500 hover:bg-lime-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
        Crear Producto
      </button>
    </div>
  </form>
